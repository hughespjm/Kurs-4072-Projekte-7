...
gdb_ergebnis = arcpy.GetParameterAsText(0) # gdb in der die Ergebnisse gespeichert werden (workspace)
dom = arcpy.GetParameterAsText(1) # Raster-Layer
park = arcpy.GetParameterAsText(2) # Feature Layer, polygon für Solar, punkte für Windpark
untersuchungsgebiet = arcpy.GetParameterAsText(3) # Feature Layer, Polygon
zu_analysierende_layer = arcpy.GetParameterAsText(4) # Feature Layer, mehrere
